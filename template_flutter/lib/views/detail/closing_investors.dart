...
import 'package:youreal/views/detail/sign_investment_contract.dart';

import 'event_stream/event_stream.dart';
import 'widget/popup_approval.dart';
import 'widget/popup_change_leader.dart';

class ClosingInvestors extends StatefulWidget {
  final Deal deal;
  const ClosingInvestors({Key? key, required this.deal}) : super(key: key);

  @override
  _ClosingInvestorsState createState() => _ClosingInvestorsState();
}

class _ClosingInvestorsState extends State<ClosingInvestors> {
  @override
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  ...
                  //     widget: SignInvestmentContract(
                  //       deal: widget.deal,
                  //     ),
                  //     page: DetailPage3Config);
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => SignInvestmentContract(deal: widget.deal,),
                    ),
                  );
                },
                child: Container(
                  ...
                  alignment: Alignment.center,
                  child: Text("CHỐT DANH SÁCH NĐT",style: kText16Bold_1,),
                ),
              ),
              SizedBox(
                height: 60,
