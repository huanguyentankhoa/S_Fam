...
import 'package:youreal/views/detail/change_owner.dart';
...
class FullPayment extends StatefulWidget {
  final Deal deal;
  const FullPayment({Key? key, required this.deal}) : super(key: key);
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  ...
                  //       deal: widget.deal,
                  //     ),
                  //     page: DetailPage5Config);
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => ChangeOwner(deal: widget.deal,),
                    ),
                  );
                },
                child: Container(
                  ...
                  alignment: Alignment.center,
                  child: Text("THANH TOÁN",style: kText16Bold_1,),
                ),
              ),
              SizedBox(
                height: 60,
