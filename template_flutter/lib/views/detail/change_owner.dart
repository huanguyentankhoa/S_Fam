...
import 'package:youreal/views/detail/close_deal.dart';

import 'event_stream/event_stream.dart';
import 'widget/popup_approval.dart';
import 'widget/popup_change_leader.dart';
class ChangeOwner extends StatefulWidget {
  final Deal deal;

  const ChangeOwner({Key? key, required this.deal}) : super(key: key);

  @override
  _ChangeOwnerState createState() => _ChangeOwnerState();
}

class _ChangeOwnerState extends State<ChangeOwner> {
  @override
            ...
            children: [
              ...
              GestureDetector(
                onTap: (){
                  ...
                  //       deal: widget.deal,
                  //     ),
                  //     page: DetailPage6Config);
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => CloseDeal(deal: widget.deal,),
                    ),
                  );
                },
                child: Container(
                ...
                children: [
                  ...
                  GestureDetector(
                    ...
                    child: Container(
                      ...
                      alignment: Alignment.center,
                      child: Text("DANH SÁCH CÁC BÊN LIÊN QUAN",style: kText16Bold_1,),
                    ),
                  ),
                ],
              ),
