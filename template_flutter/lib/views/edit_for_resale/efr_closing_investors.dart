...
import 'package:youreal/views/edit_for_resale/efr_sign_investment_contract.dart';
class EfrClosingInvestors extends StatefulWidget {
  final Deal deal;
  const EfrClosingInvestors({Key? key, required this.deal}) : super(key: key);

  @override
  _EfrClosingInvestorsState createState() => _EfrClosingInvestorsState();
}

class _EfrClosingInvestorsState extends State<EfrClosingInvestors> {
                ...
                InkWell(
                  onTap: () async {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => EfrSignInvestmentContract(deal: widget.deal,),
                      ),
                    );
                  },
                  child: Container(
                    ...
                    child: Text(
                      "Chốt danh sách nhà đầu tư".toUpperCase(),
                      style: kText16Bold_1,
                    ),
                  ),
                ),
