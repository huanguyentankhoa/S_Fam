...
import 'package:youreal/views/edit_for_resale/efr_change_owner.dart';
class EfrPayment extends StatefulWidget {
  final Deal deal;
  const EfrPayment({Key? key, required this.deal}) : super(key: key);

  @override
  _EfrPaymentState createState() => _EfrPaymentState();
}

class _EfrPaymentState extends State<EfrPayment> {
        ...
        child: GestureDetector(
          onTap: (){
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => EfrChangeOwner(deal: widget.deal,),
              ),
            );
          },
          child: Container(
