...
import 'package:youreal/views/edit_for_resale/efr_close_deal.dart';
class EfrChangeOwner extends StatefulWidget {
  final Deal deal;
  const EfrChangeOwner({Key? key, required this.deal}) : super(key: key);

  @override
  _EfrChangeOwnerState createState() => _EfrChangeOwnerState();
}

class _EfrChangeOwnerState extends State<EfrChangeOwner> {
                ...
                InkWell(
                  onTap: () async {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => EfrCloseDeal(deal: widget.deal,),
                      ),
                    );
                  },
                  child: Container(
