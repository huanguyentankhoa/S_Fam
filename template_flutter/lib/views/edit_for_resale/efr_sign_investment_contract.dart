...
import 'package:youreal/views/edit_for_resale/efr_payment.dart';
class EfrSignInvestmentContract extends StatefulWidget {
  final Deal deal;
  const EfrSignInvestmentContract({Key? key, required this.deal}) : super(key: key);

  @override
  _EfrSignInvestmentContractState createState() => _EfrSignInvestmentContractState();
}

class _EfrSignInvestmentContractState extends State<EfrSignInvestmentContract> {
                  ...
                  InkWell(
                    onTap: () async {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => EfrPayment(deal: widget.deal,),
                        ),
                      );
                    },
                    child: Container(
