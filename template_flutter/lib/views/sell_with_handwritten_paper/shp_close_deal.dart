...
class ShpCloseDeal extends StatefulWidget {
  final Deal deal;
  const ShpCloseDeal({Key? key, required this.deal}) : super(key: key);

  @override
  _ShpCloseDealState createState() => _ShpCloseDealState();
}

class _ShpCloseDealState extends State<ShpCloseDeal> {
