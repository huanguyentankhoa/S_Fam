...
import 'package:youreal/views/sell_with_handwritten_paper/shp_close_deal.dart';
class ShpChangeOwner extends StatefulWidget {
  final Deal deal;
  const ShpChangeOwner({Key? key,required this.deal}) : super(key: key);

  @override
  _ShpChangeOwnerState createState() => _ShpChangeOwnerState();
}

class _ShpChangeOwnerState extends State<ShpChangeOwner> {
  Widget _eventStreamBuild() {
    return Column(
      children: [
        timelineStartBuild("15/05", "Thực hiện trước bạ sang tên"),
        timelineBuild("13/05", "Thanh toán toàn bộ"),
        timelineBuild("12/05", "Ký hợp đồng và đặt cọc"),
                ...
                InkWell(
                  onTap: () async {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => ShpCloseDeal(deal: widget.deal,),
                      ),
                    );
                  },
                  child: Container(
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(8.h)),
                    child: Text(
                      "Danh sách các bên liên quan".toUpperCase(),
                      style: kText16Bold_1,
                    ),
                  ),
                ),
